...
int ExecuteJump(uint8_t JumpType,float JumpAngle)
{
    ...
    if (JumpType == Bridge_Jump)//标准跳（对绝大多数地面都有较好的适应性，兼具高度和远度）
    {
        ...
        AngleLoop[5].Output_limit = 28.25f;
        AngleLoop[6].Output_limit = 28.25f;
        AngleLoop[7].Output_limit = 28.25f;
        AngleLoop[8].Output_limit = 28.25f;
    ...
    else if(JumpType == StepUp_Jump)
    {
        ...
        AngleLoop[5].Output_limit = 25.0f;
        AngleLoop[6].Output_limit = 25.0f;
        AngleLoop[7].Output_limit = 25.0f;
        AngleLoop[8].Output_limit = 25.0f;
        ...
        SetPolarPositionAll_Delay(-60, jump_flylegheight, fall_time);
...
int FrontJump(void )
{
    ...
    wait_flag = 1;
    AngleLoop[1].Output_limit = 23.3f;
    AngleLoop[2].Output_limit = 23.3f;
    AngleLoop[5].Output_limit = 23.3f;
    AngleLoop[6].Output_limit = 23.3f;
 ...
 * 缩腿过高栏
 */
    SetPolarPositionLeg_Delay(-50.0f, 9.0f, 0,1);
    SetPolarPositionLeg_Delay(-50.0f, 9.0f, 0,3);
