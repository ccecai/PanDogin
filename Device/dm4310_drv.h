...
extern void pos_speed_ctrl(FDCAN_HandleTypeDef* hcan,uint16_t motor_id, float pos, float vel);
extern void speed_ctrl(FDCAN_HandleTypeDef* hcan,uint16_t motor_id, float _vel);
