...
void visual_process(void)
{
    ...
    if(visual_control_flag == 1 && Back_Camare_flag == 1 && Desk_Data[0] == 48 && Desk_Data[1] == 52 && Desk_Data[10] == 51 && Desk_Data[11] == 53)
    {
    ...
    else if(visual_control_flag == 1 && Front_Camare_flag == 1 && Desk_Data[12] == 49 && Desk_Data[13] == 53 && Desk_Data[22] == 52 && Desk_Data[23] == 54)
    {
