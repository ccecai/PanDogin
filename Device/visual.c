...
void visual_process(void)
{
    ...
    {
        visual.distance = (Desk_Data[10]-48) * 1000.0f + (Desk_Data[11]-48) * 100.0f + (Desk_Data[12]-48) * 10.0f + (Desk_Data[13]-48) * 1.0f ;
        visual.offset = (Desk_Data[14]-48) * 100.0f + (Desk_Data[15]-48) * 10.0f + (Desk_Data[16]-48) * 1.0f;

        BackIfLook = Desk_Data[17];
